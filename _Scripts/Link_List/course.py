"""The Course class creates a course object.
...
__str__() -- returns string of Course as f"cs{course_number} {course_name} Grade: {grades} Credit Hours: {credit_hrs}"
"""


class Course:
    """Creates a Course() with variables: course_number, course_name, credit_hrs, grades
    ...
    set_next(node) -- sets pointer to node
    get_next() -- returns self.next
    __str__() -- returns string of Course as
        f"cs{course_number} {course_name} Grade: {grades} Credit Hours: {credit_hrs}"
    """
